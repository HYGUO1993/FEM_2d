...
def try_import_pyqt6():
    """Try to import PyQt6 with detailed error handling."""
    try:
...
pyqt6_ok, pyqt6_error = try_import_pyqt6()

if not pyqt6_ok:
    print("Error: Failed to load PyQt6")
    print(f"Details: {pyqt6_error}")
    print()
    print("Solutions:")
    print("  1. Install PyQt6: pip install --user PyQt6")
    print("  2. Or use conda: conda install -c conda-forge pyqt")
    print()
    if "PyQt6" in pyqt6_error or "No module named" in pyqt6_error:
        print("PyQt6 package not found. Please install it.")
    else:
        print("PyQt6 is installed but failed to load (may need system libraries).")
    sys.exit(1)
