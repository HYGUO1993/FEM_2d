...
const dict = {
  ...
  "canvas.nodeCoordPlaceholder": { zh: "坐标 x,y (米), 回车创建; 支持 1000,500mm", en: "coords x,y (m), Enter to add; e.g. 1000,500mm" },
  "canvas.nodeCoordFmt": { zh: "格式: x,y 或 x y (米)", en: "Format: x,y or x y (meters)" },
  "canvas.nodeCoordDup": { zh: "({x}, {y}) 已有节点", en: "Node ({x}, {y}) already exists" },
